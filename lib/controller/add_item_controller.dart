...
class AddItemController extends GetxController{
  ...
  TextEditingController couponApplicableController = TextEditingController();
  TextEditingController startDateController = TextEditingController();
  TextEditingController endDateController = TextEditingController();
  String? selectedDiscountType;

  List<String> discountTypeList = ['a', 'b'];

  DateTime startDate = DateTime.now().subtract(const Duration(days: 6570));
  DateTime endDate = DateTime.now().subtract(const Duration(days: 6570));
