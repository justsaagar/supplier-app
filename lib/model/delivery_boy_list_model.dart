...
DeliveryBoyListModel deliveryBoyListModelFromJson(String str) => DeliveryBoyListModel.fromJson(json.decode(str));

String deliveryBoyListModelToJson(DeliveryBoyListModel data) => json.encode(data.toJson());
...
class DeliveryBoyListModel {
  ...
  factory DeliveryBoyListModel.fromJson(Map<String, dynamic> json) => DeliveryBoyListModel(
