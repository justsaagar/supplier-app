...
List<ProductSearchModel> productSearchModelFromJson(String str) =>
    List<ProductSearchModel>.from(json.decode(str).map((x) => ProductSearchModel.fromJson(x)));

String productSearchModelToJson(List<ProductSearchModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

ProductResult productResultFromJson(String str) => ProductResult.fromJson(json.decode(str));
