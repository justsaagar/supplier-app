...
class _DeliveryScreenState extends State<DeliveryScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppAppBar(title: 'Delivery', showBack: true),
      body: GetBuilder(
          init: DeliveryController(),
          initState: (state) {
            Future.delayed(const Duration(microseconds: 300), () => Get.find<DeliveryController>().getRiders());
          },
          builder: (DeliveryController deliveryController) {
            return Stack(
              ...
              children: [
                          ...
                          child: Column(
                            ...
                            children: [
                                ...
                                child: Padding(
                                  ...
                                  child: Center(
                                    child: Container(
                                      ...
                                      decoration: const BoxDecoration(color: AppColorConstant.greyBgColor, shape: BoxShape.circle),
                                      child: (deliveryController.profileImage == null || deliveryController.profileImage!.isEmpty)
                                          ? const Icon(Icons.camera_alt_outlined, size: 25)
                                          : ClipRRect(
                                              borderRadius: BorderRadius.circular(500),
                                              child: Image.file(
                                                File(deliveryController.profileImage!),
                                                height: 112,
                                                width: 112,
                                                fit: BoxFit.cover,
                                              ),
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    border: OutlineInputBorder(
                                        ...
                                        borderSide: const BorderSide(color: Color(0xFF36EB9F))),
                                  ),
                                ...
                                child: TextFormField(
                                  ...
                                  onTap: () async {
                                    ...
                                    if (pickedDate != null) {
                                      ...
                                      setState(() {
                                        deliveryController.txtDateOfBirth.text = formattedDate;
                                      });
                                    } else {
                                ...
                                child: TextFormField(
                                  ...
                                  onTap: () async {
                                    ...
                                    if (pickedDate != null) {
                                      var formattedDate = DateFormat('yyyy-MM-dd').format(pickedDate);
                                      setState(() {
                                        deliveryController.txtJoinDate.text = formattedDate;
                                      });
                                    } else {
                                      logs("Date is not selected");
                                    }
                                ...
                                child: Row(
                                  children: [
                                    Expanded(
                                      child: TextFormField(
                                          style: const TextStyle(height: 1, color: Colors.black),
                                          controller: deliveryController.txtAadhaar,
                                    ...
                                    InkWell(
                                      ...
                                      child: Container(
                                        ...
                                        child: Image.asset("assets/icons/share.png", height: 16, width: 16),
                                      ),
                                    ),
                                    const SizedBox(width: 12),
                                  ],
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  onFieldSubmitted: (text) {
                                    logs("First text field: $text");
                                    setState(() {
                                      deliveryController.txtVNumber.text = checkReg(text);
                                    });
                                  },
                                  keyboardType: TextInputType.text,
                                ...
                                child: Row(
                                  children: [
                                    Expanded(
                                      child: TextFormField(
                                          style: const TextStyle(height: 1, color: Colors.black),
                                          controller: deliveryController.txtLicenceNumber,
                                          keyboardType: TextInputType.text,
                                          textCapitalization: TextCapitalization.characters,
                                          decoration: InputDecoration(
                                            //Color(0xFF36EB9F
                                ...
                                child: TextFormField(
                                  ...
                                  onTap: () async {
                                    ...
                                    if (pickedDate != null) {
                                      var formattedDate = DateFormat('yyyy-MM-dd').format(pickedDate);
                                      setState(() {
                                        deliveryController.txtLicenceExp.text = formattedDate;
                                      });
                                    } else {
                                      logs("Date is not selected");
                                    }
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                    style: const TextStyle(height: 1, color: Colors.black),
                                    controller: deliveryController.txtDeliveryArea,
                                    keyboardType: TextInputType.text,
                                    decoration: InputDecoration(
                                      //Color(0xFF36EB9F
                                      border: OutlineInputBorder(
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                    style: const TextStyle(height: 1, color: Colors.black),
                                    controller: deliveryController.txtAccountName,
                                    keyboardType: TextInputType.text,
                                    decoration: InputDecoration(
                                      //Color(0xFF36EB9F
                                      border: OutlineInputBorder(
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  style: const TextStyle(height: 1, color: Colors.black),
                                  controller: deliveryController.txtAccountNumber,
                                  keyboardType: TextInputType.phone,
                                  decoration: InputDecoration(
                                ...
                                child: Row(
                                  children: [
                                    Expanded(
                                      child: TextFormField(
                                        style: const TextStyle(height: 1, color: Colors.black),
                                        controller: deliveryController.txtPanNumber,
                                        keyboardType: TextInputType.text,
                                        textCapitalization: TextCapitalization.characters,
                                        decoration: InputDecoration(
                              ...
                              Padding(
                                ...
                                child: Center(
                                  child: InkWell(
                                    onTap: () {
                                      if (deliveryController.profileImage == null) {
                                        'Please select profile image'.showError();
                                        return;
                                      }
                ...
                deliveryController.isLoading.isTrue ? const Center(child: CircularProgressIndicator(color: Colors.orange, backgroundColor: Colors.white10,)) : const SizedBox(),
              ],
            );
          }),
    );
                ...
                children: [
                  ...
                  const Center(
                    child: Text(
                      "Upload Photo",
                      style: TextStyle(
                          color: Color(0xFF000000), fontSize: 20, fontWeight: FontWeight.w400, fontFamily: "Poppins"),
                    ),
                  ),
                  const SizedBox(
                    height: 30.0,
                  ...
                  Row(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          GestureDetector(
                            onTap: () => deliveryController.selectProfileImage(ImageSource.gallery),
                            child: Container(
                                width: 50.00,
                                height: 50.00,
                      ...
                      Column(
                        ...
                        children: [
                          GestureDetector(
                            onTap: () => deliveryController.selectProfileImage(ImageSource.camera),
                            child: Container(
                                width: 50.00,
                                height: 50.00,
                                decoration: const BoxDecoration(
                  ...
                  Row(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          GestureDetector(
                            onTap: () => deliveryController.selectAdharImage(ImageSource.gallery),
                            child: Container(
                                width: 50.00,
                                height: 50.00,
                                decoration: const BoxDecoration(
                      ...
                      Column(
                        ...
                        children: [
                          GestureDetector(
                            onTap: () => deliveryController.selectAdharImage(ImageSource.camera),
                            child: Container(
                                width: 50.00,
                                height: 50.00,
                                decoration: const BoxDecoration(
                  ...
                  Row(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          GestureDetector(
                            onTap: () => deliveryController.selectPanImage(ImageSource.gallery),
                            child: Container(
                                width: 50.00,
                                height: 50.00,
                                decoration: const BoxDecoration(
                      ...
                      Column(
                        ...
                        children: [
                          GestureDetector(
                            onTap: () => deliveryController.selectPanImage(ImageSource.camera),
                            child: Container(
                                width: 50.00,
                                height: 50.00,
                                decoration: const BoxDecoration(
                  ...
                  Row(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          GestureDetector(
                            onTap: () => deliveryController.selectDrivingImage(ImageSource.gallery),
                            child: Container(
                                width: 50.00,
                                height: 50.00,
                                decoration: const BoxDecoration(
                      ...
                      Column(
                        ...
                        children: [
                          GestureDetector(
                            onTap: () => deliveryController.selectDrivingImage(ImageSource.camera),
                            child: Container(
                                width: 50.00,
                                height: 50.00,
                                decoration: const BoxDecoration(
